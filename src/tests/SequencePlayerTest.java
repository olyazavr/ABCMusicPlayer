...
public class SequencePlayerTest {
	...
	public void Test_piece1(){
		...
		try {        
	        ...
	        player.addNote(new Pitch('E').toMidiNote(), 60, 69);
	        player.addNote(new Pitch('F').toMidiNote(), 69, 72);
	        player.addNote(new Pitch('G').toMidiNote(), 72, 96);
	        
	        
	        player.addNote(new Pitch('C').transpose(Pitch.OCTAVE).toMidiNote(), 96, 100);
	        player.addNote(new Pitch('C').transpose(Pitch.OCTAVE).toMidiNote(), 100, 104);
	        player.addNote(new Pitch('C').transpose(Pitch.OCTAVE).toMidiNote(), 104, 108);
	       
	        player.addNote(new Pitch('G').toMidiNote(), 108, 112);
	        player.addNote(new Pitch('G').toMidiNote(), 112, 116);
	        player.addNote(new Pitch('G').toMidiNote(), 116, 120);
	        
	        player.addNote(new Pitch('E').toMidiNote(), 120, 124);
	        player.addNote(new Pitch('E').toMidiNote(), 124, 128);
	        player.addNote(new Pitch('E').toMidiNote(), 128, 132);
	        
	        player.addNote(new Pitch('C').toMidiNote(), 132, 136);
	        player.addNote(new Pitch('C').toMidiNote(), 136, 140);
	        player.addNote(new Pitch('C').toMidiNote(), 140, 144);
	        
	        player.addNote(new Pitch('G').toMidiNote(), 144, 153);
	        player.addNote(new Pitch('F').toMidiNote(), 153, 156);
	        player.addNote(new Pitch('E').toMidiNote(), 156, 165);
	        player.addNote(new Pitch('D').toMidiNote(), 165, 168);
	        player.addNote(new Pitch('C').toMidiNote(), 168, 192);
	...
	public void Test_piece2(){
		...
		try {        
	        ...
	        player.addNote(new Pitch('F').transpose(1).toMidiNote(), 6, 12);
	        player.addNote(new Pitch('E').transpose(Pitch.OCTAVE).toMidiNote(), 18, 24);
	        player.addNote(new Pitch('F').transpose(1).toMidiNote(), 18, 24);
	        player.addNote(new Pitch('C').transpose(Pitch.OCTAVE).toMidiNote(), 30, 36);
	        player.addNote(new Pitch('F').transpose(1).toMidiNote(), 30, 36);
	        player.addNote(new Pitch('E').transpose(Pitch.OCTAVE).toMidiNote(), 36, 48);
	        player.addNote(new Pitch('F').transpose(1).toMidiNote(), 36, 48);
	        ...
	        player.addNote(new Pitch('B').transpose(-2).toMidiNote(), 174, 180);
	        ...
	        player.addNote(new Pitch('C').transpose(Pitch.OCTAVE).toMidiNote(), 270, 279);
	...
	public void Test_piece3(){
		...
		try {        
	        ...
	        player.addNote(new Pitch('G').toMidiNote(), 6, 10);
	        player.addNote(new Pitch('B').toMidiNote(), 10, 11);
	        player.addNote(new Pitch('G').toMidiNote(), 11, 12);
	        
	        player.addNote(new Pitch('B').toMidiNote(), 12, 16);
	        player.addNote(new Pitch('A').toMidiNote(), 16, 18);
	        
	        player.addNote(new Pitch('G').toMidiNote(), 18, 22);
	        player.addNote(new Pitch('E').toMidiNote(), 22, 24);

	        player.addNote(new Pitch('D').toMidiNote(), 24, 28);
	        player.addNote(new Pitch('D').toMidiNote(), 28, 30);
	        
	        player.addNote(new Pitch('G').toMidiNote(), 30, 34);
	        player.addNote(new Pitch('B').toMidiNote(), 34, 35);
	        player.addNote(new Pitch('G').toMidiNote(), 35, 36);
	        
	        player.addNote(new Pitch('B').toMidiNote(), 36, 40);
	        player.addNote(new Pitch('A').toMidiNote(), 40, 42);
	        
	        player.addNote(new Pitch('D').transpose(Pitch.OCTAVE).toMidiNote(), 42, 48);
	        
	        player.addNote(new Pitch('D').transpose(Pitch.OCTAVE).toMidiNote(), 48, 50);
